...
require '../conexao.php';
$stmt = $conn->prepare("SELECT nome, empresa_nome FROM users WHERE id = ?");
$stmt->bind_param("i", $_SESSION['user_id']);
$stmt->execute();
$stmt->bind_result($nome, $empresa_nome);
$stmt->fetch();
$stmt->close();
?>
<!DOCTYPE html>
    ...
    <header>
      <div class="logo">
   	...
   	<main>
		...
		<form method="POST" action="proc_perfil_empre.php?id=<?php echo $_SESSION['user_id']; ?>" enctype="multipart/form-data"><br>
